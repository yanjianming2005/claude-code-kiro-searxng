...
class TestMessagesValidation:
    ...
    def test_accepts_inline_system_role(self, test_client, valid_proxy_api_key):
        """
        What it does: Verifies Claude Code inline system messages pass validation.
        Purpose: Current Claude Code injects system-role messages in the messages array.
        """
