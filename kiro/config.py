...
FALLBACK_MODELS: List[Dict[str, Any]] = [
    ...
    {"modelId": "claude-sonnet-5", "tokenLimits": {"maxInputTokens": 1000000, "maxOutputTokens": 128000}},
    {"modelId": "claude-opus-4.8", "tokenLimits": {"maxInputTokens": 1000000, "maxOutputTokens": 128000}},
    {"modelId": "claude-opus-4.7", "tokenLimits": {"maxInputTokens": 1000000, "maxOutputTokens": 64000}},
...
# Route queries containing Chinese characters to a local SearXNG instance.
# Disabled by default so upstream installations retain their existing behavior.
CHINESE_WEB_SEARCH_ENABLED: bool = os.getenv(
    "CHINESE_WEB_SEARCH_ENABLED", "false"
).lower() in ("true", "1", "yes")
SEARXNG_URL: str = os.getenv("SEARXNG_URL", "http://127.0.0.1:8768")
SEARXNG_ENGINES: str = os.getenv(
    "SEARXNG_ENGINES", "baidu,bing,360search,sogou"
)
SEARXNG_TIMEOUT: float = float(os.getenv("SEARXNG_TIMEOUT", "20"))
SEARXNG_RETRIES: int = int(os.getenv("SEARXNG_RETRIES", "2"))
SEARXNG_RESULT_LIMIT: int = int(os.getenv("SEARXNG_RESULT_LIMIT", "12"))
